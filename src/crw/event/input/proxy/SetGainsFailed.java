 ...
 * @author nbb
 */
public class SetGainsFailed extends InputEvent {
    ...
    public SetGainsFailed() {
    }

    public SetGainsFailed(UUID relevantOutputEventUuid, UUID missionUuid, ProxyInt proxy) {
    ...
    public SetGainsFailed(UUID relevantOutputEventUuid, UUID missionUuid, ArrayList<ProxyInt> relevantProxyList) {
        this.relevantOutputEventId = relevantOutputEventUuid;
        this.missionId = missionUuid;
    ...
    public String toString() {
        return "SetGainsFailed [" + (relevantProxyList != null ? relevantProxyList.toString() : "null") + ", " + blocking + "]";
    }
}