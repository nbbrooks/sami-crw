 ...
 */
public class NearestProxyToLocationResponse extends InputEvent {
    ...
    public NearestProxyToLocationResponse() {
        id = UUID.randomUUID();
    }

    public NearestProxyToLocationResponse(UUID relevantOutputEventUuid, UUID missionUuid, ArrayList<ProxyInt> relevantProxyList) {
