 ...
 * @author nbb
 */
public class QuantityGreater extends InputEvent {
    ...
    public QuantityGreater() {
        id = UUID.randomUUID();
    }

    public QuantityGreater(UUID relevantOutputEventUuid, UUID missionUuid, ArrayList<ProxyInt> relevantProxyList) {
