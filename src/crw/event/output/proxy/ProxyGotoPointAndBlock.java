...
public class ProxyGotoPointAndBlock extends OutputEvent {
    ...
    public ProxyGotoPointAndBlock() {
        id = UUID.randomUUID();
    }

    public ProxyGotoPointAndBlock(UUID uuid, UUID missionUuid, Hashtable<ProxyInt, Location> proxyPoints) {
        this.id = uuid;
    ...
    public String toString() {
        return "ProxyGotoPointAndBlock [" + proxyPoints + "]";
    }
}
