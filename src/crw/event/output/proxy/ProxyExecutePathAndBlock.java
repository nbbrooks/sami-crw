...
public class ProxyExecutePathAndBlock extends OutputEvent {
    ...
    public ProxyExecutePathAndBlock() {
        id = UUID.randomUUID();
    }

    public ProxyExecutePathAndBlock(UUID uuid, UUID missionUuid, Hashtable<ProxyInt, Path> proxyPaths) {
        this.id = uuid;
    ...
    public String toString() {
        return "ProxyExecutePathAndBlock [" + proxyPaths + "]";
    }
}
